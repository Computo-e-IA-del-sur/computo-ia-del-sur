...
export default function Services() {
  ...
  return (
    <section id="servicios" className="py-28 md:py-32 px-6 bg-[#051015] bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(14,42,53,1),rgba(5,16,21,1))] bg-swarm-grid">
            ...
            return (
              <Reveal key={s.title} delay={i * 0.1}>
                ...
                <div className="relative overflow-hidden bg-[#0A1E27]/40 backdrop-blur-md border border-[#2DBEED]/15 rounded-lg group transition-all duration-500 ease-out p-6 sm:p-8 hover:-translate-y-2 hover:bg-[#0A1E27]/60 hover:border-[#C9933B]/50 hover:shadow-[0_0_40px_rgba(201,147,59,0.15)]">
                  ...
                  <span
                    aria-hidden="true"
                    className="pointer-events-none select-none absolute -top-6 -right-2 text-[8rem] font-mono font-bold leading-none text-[#2DBEED]/10"
                  >
                    {s.number}
                  </span>
