      ...
      <div className="max-w-5xl mx-auto grid lg:grid-cols-[1fr_1.15fr] gap-16 items-start">
        ...
        <Reveal>
          ...
          <a
            ...
            className="inline-flex items-center gap-3 rounded-xl border border-white/10 bg-white/[0.03] backdrop-blur-md px-5 py-4 text-sm hover:border-orange-500/50 transition-colors group"
          >
            <span className="flex items-center justify-center w-9 h-9 rounded-full bg-orange-500/10 text-orange-400 shrink-0">
              <Mail className="w-4 h-4" strokeWidth={1.75} />
            </span>
            <span>
              <span className="block text-xs text-white/40">{t("directEmailLabel")}</span>
              <span className="block font-semibold text-white group-hover:text-orange-400 transition-colors">
                {CONTACT_EMAIL}
              </span>
            </span>
          </a>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                <div className="grid sm:grid-cols-2 gap-4">
                  <input
                    ...
                    required
                    className="w-full px-5 py-4 rounded-xl border border-white/10 bg-white/5 text-white placeholder-white/30 focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-500/10 transition-colors text-sm"
                  />
                  <input
                    type="email"
                    name="email"
                ...
                <textarea
                  ...
                  rows={5}
                  required
                  className="w-full px-5 py-4 rounded-xl border border-white/10 bg-white/5 text-white placeholder-white/30 focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-500/10 transition-colors resize-none text-sm"
                />

                <button
                  type="submit"
                  disabled={status === "sending"}
                  className="btn-glow w-full py-4 rounded-full bg-orange-500 text-white font-semibold hover:bg-orange-600 disabled:opacity-60 disabled:cursor-not-allowed"
                >
                ...
                <p className="text-xs text-white/40 text-center">
                  {t.rich("consent", {
                    link: (chunks) => (
                      <a href="/privacidad" className="underline hover:text-orange-400">
                        {chunks}
                      </a>
                    ),
                  })}
